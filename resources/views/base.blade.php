    ...
    <div class="pageWrapper">
                                                    ...
                                                    <div class="lvl-1 col-12 col-md-3 col-lg-3 product-menu">
                                                        ...
                                                        <div class="grid-products text-center">
                                                            <div class="product-image">
                                                                <a href="product-layout1.html" class="grid-view-item__link"><img src="assets/images/megamenu/megamenu-product_286x400.jpg" alt="image" title="" /></a>
                                                            </div>
                                                    ...
                                                    <div class="col-12 imageCol">
                                                        <div class="row mm2-banner">
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                <a href="shop-left-sidebar.html"><img src="assets/images/megamenu/megamenu-bg2_600x160.jpg" alt="image" /></a>
                                                            </div>
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                <a href="shop-listview-sidebar.html"><img src="assets/images/megamenu/megamenu-bg2_600x160.jpg" alt="image" /></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="megamenu style2">
                                                <ul class="row mmWrapper">
                                                    ...
                                                    <li class="col-12 imageCol">
                                                        <a href="#"><img src="assets/images/megamenu/megamenu-bg4_1200x100.jpg" alt="image" /></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <div class="minicart-body">
                        ...
                        <div id="drawer-minicart" class="block block-cart">
                            <ul class="mini-products-list">
                                <li class="item">
                                    <a class="product-image" href="cart.html"><img src="assets/images/product-images/minicart_250x350.jpg" alt="Frayed Layered Sleeve" title=""></a>
                                ...
                                <li class="item">
                                    <a class="product-image" href="cart.html"><img src="assets/images/product-images/minicart_250x350.jpg" alt="Floral Lined Jacket" title=""></a>
                                    <div class="product-details">
                                        <a href="#" class="remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><i class="an an-times" aria-hidden="true"></i></a>
                                        <a href="#" class="edit-i remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="an an-edit" aria-hidden="true"></i></a>
                                ...
                                <li class="item">
                                    <a class="product-image" href="cart.html"><img src="assets/images/product-images/minicart_250x350.jpg" alt="Fit & Flare Trim Dress" title=""></a>
                                    <div class="product-details">
                                        <a href="#" class="remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><i class="an an-times" aria-hidden="true"></i></a>
                                        <a href="#" class="edit-i remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="an an-edit" aria-hidden="true"></i></a>
        ...
        <div id="open-addtocart-popup" class="addtocart-popup magnific-popup mfp-hide">
            <div class="addtocart-inner text-center clearfix">
                ...
                <div class="pro-img">
                    <img class="img-fluid blur-up lazyload" src="assets/images/product-images/addtocart-popup_200x250.jpg" data-src="assets/images/product-images/addtocart-popup_200x250.jpg" alt="image" title="image" />
                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="quickview-details mb-3 mb-md-0">
                                ...
                                <div class="quickview-details-img quickview-thumbnails-single">
                                    <div class="item">
                                        <img src="assets/images/product-images/product-large_1000x1400.jpg" data-src="assets/images/product-images/product-large_1000x1400.jpg" alt="image" />
                                    </div>
                                    <div class="item">
                                        <img src="assets/images/product-images/product-large_1000x1400.jpg" data-src="assets/images/product-images/product-large_1000x1400.jpg" alt="image" />
                                    </div>
                                ...
                                <div class="product-thumb-lists quickview-thumbnail-items">
                                    <div class="item">
                                        <img class="blur-up lazyload" src="assets/images/product-images/product-thumb_100x125.jpg" data-src="assets/images/product-images/product-thumb_100x125.jpg" alt="image" />
                                    </div>
                                    <div class="item">
                                        <img class="blur-up lazyload" src="assets/images/product-images/product-thumb_100x125.jpg" data-src="assets/images/product-images/product-thumb_100x125.jpg" alt="image" />
                                    </div>
                ...
                <div class="suggestion-item">
                    <div class="d-table suggestion-product">
                        <div class="d-table-cell align-middle">
                            <img class="img-fluid blur-up lazyload" src="assets/images/product-images/variant1_200x200.jpg" data-src="assets/images/product-images/variant1_200x200.jpg" width="85" alt="image" title="image" />
                        </div>
        ...
        <div class="newsletter-wrap" id="popup-container">
            <div id="popup-window">
                ...
                <div class="display-table splash-bg">
                    <div class="display-table-cell width40"><img src="assets/images/newsletter-img_300x350.jpg" alt="Join Our Mailing List" title="Join Our Mailing List" /></div>
